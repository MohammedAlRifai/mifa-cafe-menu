...
export const LOCAL_IMAGE_MAP: Record<string, { localPaths: string[]; fallback: string }> = {
  // Tea & Warm Drinks
  'red-tea-glass': {
    localPaths: ['/images/شاي احمر.jpg', '/images/شاي_احمر.jpg', '/images/red-tea.jpg'],
...
export function handleImageFallback(
  ...
  const mapping = LOCAL_IMAGE_MAP[itemId];
  const fallbackUrl = currentFallback || (mapping ? mapping.fallback : 'https://images.unsplash.com/photo-1509042239860-f550ce710b93?w=800&q=80&auto=format&fit=crop');
